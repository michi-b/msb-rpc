...
internal static class NamespaceSymbolExtensions
{
    ...
    public static bool GetIsMsbRpc(this INamespaceSymbol target) => target.Name == "MsbRpc" && target.ContainingNamespace.IsGlobalNamespace;
    ...
    public static bool GetIsGenerator(this INamespaceSymbol target) => target.Name == "Generator" && target.ContainingNamespace.GetIsMsbRpc();
    ...
    public static bool GetIsSerialization(this INamespaceSymbol target) => target.Name == "Serialization" && target.ContainingNamespace.GetIsMsbRpc();
