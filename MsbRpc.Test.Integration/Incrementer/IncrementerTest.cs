...
public class IncrementerTest : Test
{
    ...
    public async Task CanIncrement10TimesFrom5To15()
    {
        ...
        IncrementerServerEndPoint serverEndPoint = new(new Messenger(new RpcSocket(serverSocket)), LoggerFactory);
        ...
        var incrementerServerImplementation = new Incrementer();
